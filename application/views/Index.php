                ...
                statusCode:{
                    403 : function () {
                        Swal.fire({
                              type: 'error',
                              title: 'Oops...',
                              text: 'Permission Denied. Silahkan Hubungi sistem Administrator',
                              footer: '<a href>Why do I have this issue?</a>'
                            }).then((result)=>{
                                $('#username').val('');
                                $('#password').val('');
                    ...
                    404 : function () {
                        Swal.fire({
                              type: 'error',
                              title: 'Oops...',
                              text: 'The requested page not found. [404]. Silahkan Hubungi sistem Administrator',
                              footer: '<a href>Why do I have this issue?</a>'
                            }).then((result)=>{
                                $('#username').val('');
                                $('#password').val('');
                    ...
                    500 : function () {
                        Swal.fire({
                              type: 'error',
                              title: 'Oops...',
                              text: 'Internal Server Error [500]. Silahkan Hubungi sistem Administrator',
                              footer: '<a href>Why do I have this issue?</a>'
                            }).then((result)=>{
                                $('#username').val('');
                                $('#password').val('');
                    ...
                    0 : function () {
                        Swal.fire({
                              type: 'error',
                              title: 'Oops...',
                              text: 'Not connected.Please verify your network connection.. Silahkan Hubungi sistem Administrator',
                              footer: '<a href>Why do I have this issue?</a>'
                            }).then((result)=>{
                                $('#username').val('');
                                $('#password').val('');
